...
public:
	...
	*/
	...
	/** @brief begin del conjunto
	@return Devuelve un iterador seguro al primer elemento del conjunto. Si no existe devuelve end
	*/
	secure_iterator sbegin ();

	/** @brief begin del conjunto
	@return Devuelve un iterador seguro constante al primer elemento del conjunto. Si no existe devuelve end
	*/
...
private:
	friend class impar_iterator; //Itera sobre mutaciones con posición impar
	friend class secure_iterator; //Itera asegurando que las posiciones son correctas dentro del vector
	friend class iterator;
	friend class const_impar_iterator; //Itera sobre mutaciones con posición impar
	friend class const_secure_iterator; //Itera asegurando que las posiciones son correctas dentro del vector
